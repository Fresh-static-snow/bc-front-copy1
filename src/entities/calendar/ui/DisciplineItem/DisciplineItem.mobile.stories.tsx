...
import { DisciplineItemMobile } from './DisciplineItem.mobile';

export default {
  title: 'entities/calendar/DisciplineItemMobile',
  component: DisciplineItemMobile,
  tags: ['autodocs'],
  argTypes: {
    ...
    day: { control: { type: null } },
  },
} as Meta<typeof DisciplineItemMobile>;

type Story = StoryObj<typeof DisciplineItemMobile>;
type StoryTemplate = StoryFn<typeof DisciplineItemMobile>;
...
const Template: StoryTemplate = (args) => (
  ...
  >
    <DisciplineItemMobile discipline={discipline} tournaments={tournaments} {...args} />
  </div>
);
...
<div
  ...
  >
  <DisciplineItemMobile discipline={discipline} tournaments={tournaments} />
</div>
        `,
      },
    },
