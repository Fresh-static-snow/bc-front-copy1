...
import { useTournamentMenuStore } from '../../model';
...
export const Menu: React.FC = () => {
  ...
  const editingRequestType = useTournamentMenuStore((state) => state.editingRequestType);
  ...
  const onChangeTab = (tab: TabValue) => {
    ...
    navigate(`/calendar/tournament/${eventId}/${tab.value}`, { state });
  };
        ...
        AdditionalComponent={
          <AccessControl
            necessaryPermissions={[
              'get::/api/v1/tournaments/:id/edit',
