...
import { CreateSegment } from '../ui/CreateSegment/CreateSegment';
...
describe('features/management/CreateSegment', () => {
  beforeEach(() => {
    window.open = vi.fn();
  ...
  it('render CreateSegment', () => {
    const { getByText, getByTestId, getAllByText } = render(
      <TestProvider>
        <CreateSegment setEntityModal={vi.fn()} />
      </TestProvider>,
    );
