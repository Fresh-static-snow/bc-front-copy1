...
import { CorporateRangeRow } from '../CorporateRangeRow/CorporateRangeRow';
import { DisciplineTitle } from '../DisciplineTitle/DisciplineTitle';
import { TournamentRangeRow } from '../TournamentRangeRow/TournamentRangeRow';
import * as S from './QuarterRangeItem.styles';
import { QuarterRangeItemProps } from './QuarterRangeItem.types';

export const QuarterRangeItem: React.FC<QuarterRangeItemProps> = memo(
  ({
    activeDate,
    discipline,
    tournaments,
