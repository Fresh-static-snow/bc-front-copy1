...
import { TabsMenuMobile } from './TabsMenu.mobile';

export default {
  title: 'shared/layouts/TabsMenuMobile',
  component: TabsMenuMobile,
  tags: ['autodocs'],
  argTypes: {
...
} as Meta<typeof TabsMenuMobile>;

type Story = StoryObj<typeof TabsMenuMobile>;
type StoryTemplate = StoryFn<typeof TabsMenuMobile>;
...
const Template: StoryTemplate = (args) => {
  ...
  return <TabsMenuMobile {...args} activeTab={activeTab} onChangeTab={handleChangeTab} />;
};
